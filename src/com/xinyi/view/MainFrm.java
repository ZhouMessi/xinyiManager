...
//	private JDesktopPane desktopPane =  initDePane();
	...
	public MainFrm() throws Exception {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(MainFrm.class.getResource("/images/nextapp_systempanel_ui_homeactivity_24px_1135522_easyicon.net.png")));
     ...
     // 设置分隔条的大小（宽度）
		...
		//获取代理对象
		jumpButton proxy = (jumpButton) proxyHandler.getProxyInstance(target);
